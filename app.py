# app.py (Final Corrected Version 2)
...
def ask_gemini(user_id, user_text):
    ...
    try:
        ...
        # --- แก้ไข: ดึงข้อมูลจาก Gemini API ให้ถูกต้อง ---
        ...
        # Command Parsing (ปรับปรุงให้สั้นและปลอดภัยขึ้น)
